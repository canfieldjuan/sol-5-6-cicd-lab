...
Read `.codex-review-context.json`, the repository's `AGENTS.md`, and the exact
base-to-current-head diff named in the context file. Confirm that `HEAD` equals
the requested current head before reviewing. Treat the PR title and body as
